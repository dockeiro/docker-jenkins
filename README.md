...
```
docker run -p 8080:8080 -p 50000:50000 -v /var/run/docker.sock:/var/run/docker.sock gustavo8000br/docker-jenkins:lts
```
...
```
docker run -p 8080:8080 -p 50000:50000 -v /var/run/docker.sock:/var/run/docker.sock -v jenkins_home:/var/jenkins_home gustavo8000br/docker-jenkins:lts
```
...
```
FROM gustavo8000br/docker-jenkins:lts
...
```
docker run --name myjenkins -p 8080:8080 -p 50000:50000  -v /var/run/docker.sock:/var/run/docker.sock --env JAVA_OPTS=-Dhudson.footerURL=http://mycompany.com  gustavo8000br/docker-jenkins:lts
```
...
EOF
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS="-Djava.util.logging.config.file=/var/jenkins_home/log.properties" -v `pwd`/data:/var/jenkins_home  gustavo8000br/docker-jenkins:lts
```
...
```
docker run  gustavo8000br/docker-jenkins:lts --version
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50001:50001 --env JENKINS_SLAVE_AGENT_PORT=50001  gustavo8000br/docker-jenkins:lts
```
...
Build with the usual
    ...
    docker build -t  gustavo8000br/docker-jenkins .
